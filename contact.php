        ...
        <?php
            ...
            if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
                if($method == 'POST'){
                    ...
                    $sql = "INSERT INTO `contacts` ( `name`, `email`, `feedback`) VALUES ('$name', '$email', '$feedback');";
        ...
        if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
            echo'<form action="' .$_SERVER['REQUEST_URI'] .'" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="feedback" name="feedback" rows="9" maxlength=1000></textarea>
